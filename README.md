...
AlienCommons is a community platform built for Minecraft players. It provides a space for players to publish articles and participate in discussions.
...
All documentation is available in English and Chinese and built with [Zensical](https://zensical.org/).
